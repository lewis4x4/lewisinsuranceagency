...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in Fort White, FL. Compare independent vs captive agents. Free quotes from 20+ carriers. Local Columbia County service.",
    alternates: {
