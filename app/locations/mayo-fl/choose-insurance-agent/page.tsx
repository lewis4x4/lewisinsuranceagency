...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in Mayo, FL. Compare independent vs captive agents. Free quotes from 20+ carriers. Local Lafayette County service.",
    alternates: {
