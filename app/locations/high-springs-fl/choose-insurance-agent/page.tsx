...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in High Springs, FL. Compare independent vs captive agents. Free quotes from 20+ carriers. Local Alachua County service.",
    alternates: {
