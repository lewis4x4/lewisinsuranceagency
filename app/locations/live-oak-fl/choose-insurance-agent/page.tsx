...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in Live Oak, FL. Compare independent vs captive agents. Free quotes from 20+ carriers. Local Suwannee County service.",
    alternates: {
