...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in Macclenny, FL. Compare independent vs captive agents. Free quotes from 30+ carriers. Local Baker County service.",
    alternates: {
        canonical: "https://lewisinsurance.com/locations/macclenny-fl/choose-insurance-agent",
    },
    openGraph: {
        title: "How to Choose an Insurance Agent in Macclenny, FL",
        description: "How to choose an insurance agent in Macclenny, FL. Compare independent vs captive agents. Free quotes from 30+ carriers. Local Baker County service.",
