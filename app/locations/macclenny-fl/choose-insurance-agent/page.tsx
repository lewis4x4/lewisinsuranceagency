...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in Macclenny, FL. Compare independent vs captive agents. Free quotes from 20+ carriers. Local Baker County service.",
    alternates: {
