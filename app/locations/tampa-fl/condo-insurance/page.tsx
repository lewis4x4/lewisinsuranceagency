...
const pageData: CityServicePageData = {
    ...
    description: "Tampa condo insurance from independent Florida agents. HO-6 policies covering interior, personal property, and liability. Serving Hillsborough County condo owners.",
