...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in Jacksonville, FL. Compare independent vs captive agents. Free quotes from 20+ carriers. Local Duval County service.",
    alternates: {
