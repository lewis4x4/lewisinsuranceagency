...
const citySlug = "jacksonville-fl"
const county = "Duval"
const nearbyTowns = ["Orange Park", "Atlantic Beach", "Neptune Beach", "Ponte Vedra"]
const localEntities = ["I-95", "I-10", "Downtown Jacksonville", "Southside area"]

export const metadata: Metadata = {
    title: "How to Choose an Insurance Agent in Jacksonville, FL",
    description: "Find the right insurance agent in Jacksonville, FL. Learn what to look for in an independent agency, compare options, and get Florida-specific guidance. Serving Duval County since 1981.",
    alternates: {
        canonical: `https://lewisinsurance.com/locations/${citySlug}/choose-insurance-agent`,
    },
    openGraph: {
        title: "How to Choose an Insurance Agent in Jacksonville, FL",
        description: "Find the right insurance agent in Jacksonville, FL. Learn what to look for in an independent agency, compare options, and get Florida-specific guidance.",
...
const faqs = [
    {
        ...
        answer: "No. Insurance carriers compensate agents—you don't pay extra. Your premium is identical whether you purchase direct or through an agent. Independent agents add value by comparing multiple carriers to find options for your situation.",
    },
    {
        question: "What information do you need to compare quotes?",
        answer: "For auto, we need driver information, vehicle details, and driving history. For homeowners, we need address, property details, roof information, and updates. Jacksonville's varied neighborhoods—from downtown condos to beach homes to suburban houses—each have different considerations.",
    },
    {
        question: "Can you shop multiple carriers at renewal?",
        answer: "Yes. We review policies annually and can compare options from different carriers if rates increase or better coverage becomes available. This flexibility is a key advantage of working with an independent agency.",
    },
    {
        question: "What affects my insurance rate in Jacksonville?",
        answer: "Auto rates consider driving record, vehicle, coverage limits, and commute patterns. Home insurance factors include location within Jacksonville, roof condition, construction, flood zone, coastal proximity, and claims history.",
    },
    {
        question: "How do Florida wind deductibles work?",
        answer: "Florida homeowners policies have separate hurricane/wind deductibles, typically 2% of dwelling coverage. For a $350,000 home, that's a $7,000 hurricane deductible versus perhaps a $2,500 standard deductible. Coastal proximity can affect wind rates.",
    },
    {
        question: "Can you help me if I have a claim?",
        answer: "We guide you through the claims process and explain what documentation is typically needed. Claims decisions are made by the insurance carrier, but we help you understand your coverage and answer questions throughout the process.",
    },
    {
        question: "How fast can I get proof of insurance?",
        answer: "Same day in most cases once coverage is bound. Auto ID cards, certificates of insurance, and evidence of property coverage are provided quickly when you need documentation.",
    },
]
...
export default function JacksonvilleChooseInsuranceAgentPage() {
    const schemaFAQ = {
                    ...
                    <div className="max-w-3xl">
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-start gap-3">
                                ...
                                <span className="text-lewis-body">Independent agents work with multiple carriers—more options than being locked to one company</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <CheckCircle2 className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                                <span className="text-lewis-body">{city}'s coastal proximity and size create varied insurance considerations across neighborhoods</span>
                            </li>
                            <li className="flex items-start gap-3">
                                <CheckCircle2 className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
                                <span className="text-lewis-body">A local agent reviews your coverage annually and can shop alternatives when rates change</span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div className="container-lg">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-lewis-body mb-6">
                            In a city as large and varied as {city}, your choice of insurance agent matters. Here's what to consider:
                        </p>
                        <div className="grid gap-3">
                            {[
                                ...
                                "Understanding of coastal insurance considerations",
                                "Knowledge of Jacksonville's varied neighborhoods",
                        ...
                        <div className="grid md:grid-cols-3 gap-6">
                            <Card className="p-6">
                                ...
                                <p className="text-sm text-lewis-body">
                                    Partners with multiple insurance carriers. Compares your options across companies and can move coverage when better choices appear.
                                </p>
                            </Card>
                            <Card className="p-6">
                                ...
                                <p className="text-sm text-lewis-body">
                                    Works for one insurance company exclusively. Limited to that carrier's products. Personal service but no comparison shopping ability.
                                </p>
                            </Card>
                            <Card className="p-6">
                                <div className="w-12 h-12 rounded-full bg-gray-100 flex items-center justify-center mb-4">
                                ...
                                <p className="text-sm text-lewis-body">
                                    Buy from a carrier's website or call center. No agent relationship. You handle comparisons, changes, and service yourself.
                                </p>
                            </Card>
                        </div>
                    </div>
                    ...
                    <div className="max-w-3xl">
                        ...
                        <div className="prose prose-lewis">
                            <p className="text-lewis-body mb-4">
                                {city} sprawls across {county} County, from {localEntities[2]} to the {localEntities[3]} and out to the beaches. {localEntities[0]} and {localEntities[1]} connect the metro area. This geographic diversity means insurance considerations vary significantly by neighborhood—coastal properties face different risks than inland areas.
                            </p>
                            <p className="text-lewis-body mb-4">
                                Flood zones change throughout {city}—areas near the St. Johns River, Intracoastal Waterway, and beaches may require flood insurance. Wind coverage is part of homeowners policies, but Florida's hurricane deductible (typically 2% of dwelling coverage) affects all properties. Coastal proximity can influence wind rates.
                            </p>
                            <p className="text-lewis-body">
                                Auto insurance in Florida requires PIP coverage. {city}'s size means commute patterns vary widely—distance driven, parking location, and vehicle type all affect rates. An agent familiar with {county} County can help match coverage to your actual situation.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="container-lg">
                    <div className="max-w-3xl">
                        ...
                        <p className="text-white/90 mb-6">
                            Whether you need new coverage or want to review existing policies, we can help. As an independent agency, we compare options from multiple carriers to find what works for your situation. We also serve {nearbyTowns[0]}, {nearbyTowns[1]}, {nearbyTowns[2]}, and surrounding areas.
                        </p>
                ...
                <div className="container-lg">
                    <div className="max-w-3xl">
                        ...
                        <div className="prose prose-lewis text-lewis-body">
                            <p>
                                For more on how agent types differ, see our <Link href="/why-local-agent" className="text-lewis-blue hover:underline">Local Agent vs Direct Insurance</Link> comparison. Browse common questions in our <Link href="/learn" className="text-lewis-blue hover:underline">Insurance FAQ</Link> section.
                            </p>
                            <p>
