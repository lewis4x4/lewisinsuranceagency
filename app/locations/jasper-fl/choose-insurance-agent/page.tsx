...
export const metadata: Metadata = {
    ...
    description: "How to choose an insurance agent in Jasper, FL. Compare independent vs captive agents. Free quotes from 20+ carriers. Local Hamilton County service.",
    alternates: {
